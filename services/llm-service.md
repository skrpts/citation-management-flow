...
id: llm-service
title: LLM Service
description: "Language model service providing citation and bibliography management capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for citation and bibliography management. Used by all skills in this skrpt.
